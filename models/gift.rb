...
# Triggers:
#  check_event_user                       | BEFORE INSERT ON gifts FOR EACH ROW EXECUTE FUNCTION check_event_user()
#  pgt_ca_inserted_at                     | BEFORE INSERT OR UPDATE ON gifts FOR EACH ROW EXECUTE FUNCTION inserted_at()
#  pgt_cc_events__id__num_gifts__event_id | BEFORE INSERT OR DELETE ON gifts FOR EACH ROW EXECUTE FUNCTION cc_event_num_gifts()
#  pgt_im_event_id                        | BEFORE UPDATE ON gifts FOR EACH ROW EXECUTE FUNCTION immutable_event_id()
#  pgt_im_events_id                       | BEFORE UPDATE ON gifts FOR EACH ROW EXECUTE FUNCTION immutable_event_id()
#  pgt_im_user_id                         | BEFORE UPDATE ON gifts FOR EACH ROW EXECUTE FUNCTION immutable_user_id()
